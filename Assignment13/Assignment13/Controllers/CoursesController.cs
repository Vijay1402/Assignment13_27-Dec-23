...
namespace Assignment13.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CId,Cname,CFee,Status,Tech")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CId,Cname,CFee,Status,Tech")] Course course)
        {
            if (ModelState.IsValid)
            {
